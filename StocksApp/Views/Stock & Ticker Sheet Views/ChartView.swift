...
struct ChartView_Previews: PreviewProvider {
    ...
    static func chartViewModel(range: ChartRange, stub: ChartData) -> ChartViewModel {
        ...
        mock.stubbedFetchChartDataCallback = { _ in stub }
        let chartVM = ChartViewModel(ticker: .stub, stocksApi: mock)
...
struct ChartContainerView_Previews: View {
    ...
    var body: some View {
        VStack {
            ...
            if let chatViewData = vm.chart {
                ChartView(data: chatViewData, vm: vm)
            }
        }
        .padding()
        .frame(maxHeight: 272)
